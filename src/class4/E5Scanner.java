...
public class E5Scanner {
    public static void main(String[] args) {
        ...
        scan => is a vatiable of type scanner just like we create a variable of type String
        new=> is special keyword which create the object of a class
        Scanner.in =>means we want to use the scanner class for taking the user input
         */
